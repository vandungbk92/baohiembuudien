...
import { add, getById, getAll, delById, updateById } from '@services/danhmucdulieu/loaihinhkinhteService';
import { 
  getAll as getAllLoaiPhieu

} from '@services/danhmucloaiphieuService';
...
class LoaiHinhKinhTe extends Component {
  ...
  render() {
    ...
    return <div>
      ...
      <Card size="small" title={<span>
        <UnorderedListOutlined className="icon-card-header"/> &nbsp;Danh sách loại hình kinh tế của bệnh viện
...
export default withConnect(LoaiHinhKinhTe);