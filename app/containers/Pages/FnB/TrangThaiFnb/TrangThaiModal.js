...
import { add, updateById } from '@services/fnb/trangthaifnbService';
import { createStructuredSelector } from 'reselect';
import { makeGetLoading } from '@containers/App/AppProvider/selectors';
import { connect } from 'react-redux';


class TrangThaiFnBModal extends Component {
  ...
  handleSaveData = async (dataForm) => {
    ...
    if (data) {
      ...
      if(apiResponse){
        ...
        this.props.dispatch(fetchTrangThaiFnB());
...
export default withConnect(TrangThaiFnBModal);
