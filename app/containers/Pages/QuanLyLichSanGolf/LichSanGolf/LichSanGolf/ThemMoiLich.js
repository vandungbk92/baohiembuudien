...
class ThemMoiLich extends Component {
  ...
  async componentDidMount() {
    ...
    this.state.dataRes.tungay = this.state.dataRes.tungay ? moment(this.state.dataRes.tungay) : '';
    this.state.dataRes.denngay = this.state.dataRes.denngay ? moment(this.state.dataRes.denngay) : '';
