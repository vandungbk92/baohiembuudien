...
import { add, getById, getAll, delById, updateById } from '@services/quanlyvoucher/trangthaivoucherService';
...
import DonViTinhModal from '@containers/Pages/QuanLyVoucher/TrangThaiVoucher/TrangThaiModal';
import { makeGetMyInfo } from '../../../Layout/HeaderComponent/HeaderProvider/selectors';
import { CONSTANTS } from '@constants';



class TrangThaiVoucher extends Component {
  ...
  async getDataFilter() {
    ...
    let queryStr = '';
    queryStr += `${search.tentrangthai ? '&tentrangthai[like]={0}'.format(search.tentrangthai) : ''}`;
...
export default withConnect(TrangThaiVoucher);
