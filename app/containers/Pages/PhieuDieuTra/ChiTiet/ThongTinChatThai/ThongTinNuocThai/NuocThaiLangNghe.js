...
class NuocThaiLangNghe extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} name="form_chatthainuocthai" layout='vertical' size='small' autoComplete='off'
      ...
      <Row gutter={10}>
        ...
        <Col sm={24}><strong>c. Đơn vị tiếp nhận, xử lý nước thải</strong></Col>
        <Col {...layoutCol3}>
      ...
      {/* PHIẾU 1,2*/}
      <Col sm={24}><strong> e. Kết quả xử lý nước thải: (Theo Báo cáo kết quả GSMT định kỳ của năm gần nhất (nếucó)):</strong></Col>
      <Row gutter={10}>
...
export default compose(withConnect)(NuocThaiLangNghe);
