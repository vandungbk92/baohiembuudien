...
class ThongTinNuocThai extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} name="form_chatthainuocthai" layout='vertical' size='small' autoComplete='off'
      ...
      {/* PHIẾU 1,2*/}
      <Col sm={24}><strong> e. Kết quả xử lý nước thải: (Theo Báo cáo kết quả GSMT định kỳ của năm gần nhất
        (nếucó)):</strong></Col>
      <Row gutter={10}>
        ...
        <Col {...layoutCol7}>
          <Form.Item label={<p>Tổng P</p>} name="tongptruoctaptrung" validateTrigger={['onChange', 'onBlur']}>
            <Input suffix="mg/l" disabled={loading}/>
          </Form.Item>
        </Col>
        <Col {...layoutCol7}>
          <Form.Item label='Dầu mỡ khoáng' name="daumotruoctaptrung" validateTrigger={['onChange', 'onBlur']}>
            <Input suffix="mg/l" disabled={loading}/>
          </Form.Item>
        </Col>
        <Col {...layoutCol7}>
      ...
      <Row gutter={10}>
        ...
        <Col {...layoutCol7}>
          <Form.Item label={<p>Tổng P</p>} name="tongpsautaptrung" validateTrigger={['onChange', 'onBlur']}>
            <Input suffix="mg/l" disabled={loading}/>
          </Form.Item>
        </Col>
        <Col {...layoutCol7}>
          <Form.Item label='Dầu mỡ khoáng' name="daumosautaptrung" validateTrigger={['onChange', 'onBlur']}>
            <Input suffix="mg/l" disabled={loading}/>
          </Form.Item>
        </Col>
        <Col {...layoutCol7}>
...
export default compose(withConnect)(ThongTinNuocThai);
