...
class NuocThaiChanNuoi extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} name="form_chatthainuocthai" layout='vertical' size='small' autoComplete='off'
      ...
      <Row gutter={10}>
        <Col sm={24}><strong>2. Thông tin về xử lý nước thải</strong></Col>
        <Col sm={24}><strong>a. Kết nối quan trắc nước thải tự động</strong></Col>

        <Col {...layoutCol2}>
          <Form.Item label='Có quan trắc nước thải tự động không:' name="quantracnuocthai">
      ...
      <Row gutter={10}>
        <Col sm={24}><strong>b.Hệ thống xử lý nước thải</strong></Col>
        <Col {...layoutCol}>
        ...
        <Col sm={24}><strong>c. Đơn vị tiếp nhận, xử lý chất thải rắn sinh hoạt</strong></Col>
        <Col {...layoutCol3}>
     ...
     {/* PHIẾU 3 */}
      <Col sm={24}><strong>PHIẾU 3: e. Kết quả xử lý: (Theo Báo cáo kết quả GSMT định kỳ của năm gần nhất (nếu có)): </strong></Col>  
      <Row gutter={10}>
        ...
        <Col {...layoutCol7}>
          <Form.Item label='COD' name="tongcodtruoctaptrung" validateTrigger={['onChange', 'onBlur']}>
            <Input suffix="mg/l" disabled={loading}/>
          </Form.Item>
        </Col>
        <Col {...layoutCol7}>
        ...
        <Col {...layoutCol7}>
          <Form.Item label={<p>Tổng N</p>} name="tongntruoctaptrung" validateTrigger={['onChange', 'onBlur']}>
            <Input suffix="mg/l" disabled={loading}/>
          </Form.Item>
        </Col>
        <Col {...layoutCol7}>
      ...
      <Row gutter={10}>
        <Col sm={24}><strong>1. Sau HTXLNT tập trung</strong></Col>
        ...
        <Col {...layoutCol7}>
          <Form.Item label='COD' name="tongcodsautaptrung" validateTrigger={['onChange', 'onBlur']}>
            <Input suffix="mg/l" disabled={loading}/>
          </Form.Item>
        </Col>
        <Col {...layoutCol7}>
        ...
        <Col {...layoutCol7}>
          <Form.Item label={<p>Tổng N</p>} name="tongnsautaptrung" validateTrigger={['onChange', 'onBlur']}>
            <Input suffix="mg/l" disabled={loading}/>
          </Form.Item>
        </Col>
        <Col {...layoutCol7}>
...
export default compose(withConnect)(NuocThaiChanNuoi);
