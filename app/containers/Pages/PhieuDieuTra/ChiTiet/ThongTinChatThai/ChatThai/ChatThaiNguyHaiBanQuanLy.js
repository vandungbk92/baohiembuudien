...
class ChatThaiNguyHaiBanQuanLy extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} name="form_chatthainguyhai" layout='vertical' size='small' autoComplete='off'
      ...
      <Divider orientation="left">2. Chất thải nguy hại</Divider>
      <Row gutter={10}>
        <Col {...layoutCol2}>
...
export default compose(withConnect)(ChatThaiNguyHaiBanQuanLy);
