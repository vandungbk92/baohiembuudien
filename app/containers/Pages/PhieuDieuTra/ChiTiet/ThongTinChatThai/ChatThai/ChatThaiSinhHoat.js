...
class ChatThaiSinhHoat extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} name="form_chatthaisinhhoat" layout='vertical' size='small' autoComplete='off'
      ...
      <Row gutter={10}>
        ...
        {/*<Col xs={24}><strong>1. CHẤT THẢI RẮN SINH HOẠT</strong></Col>*/}
        <Col {...layoutCol}>
      ...
      <Col sm={24}><strong>e. Đơn vị tiếp nhận, xử lý chất thải rắn sinh hoạt</strong></Col>
      <Row gutter={10}>
        <Col {...layoutCol3}>
          <Form.Item label="Tên cơ sở tiếp nhận, xử lý" name="cosotiepnhan"
                     validateTrigger={['onChange', 'onBlur']}
        ...
        <Col {...layoutCol3}>
          <Row gutter={10}>
            ...
            <Col {...layoutCol1}>
              <Form.Item label="Địa chỉ tiếp nhận" name="thontotiepnhan"
                         validateTrigger={['onChange', 'onBlur']}>
...
export default compose(withConnect)(ChatThaiSinhHoat);
