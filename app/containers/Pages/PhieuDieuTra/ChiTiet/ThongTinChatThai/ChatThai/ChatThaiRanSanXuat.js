...
class ChatThaiRanSanXuat extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} name="form_chatthaicongnghiep" layout='vertical' size='small' autoComplete='off'
      ...
      <Divider orientation="left">2. Chất thải rắn sản xuất</Divider>
      <Row gutter={10}>
        <Col {...layoutCol}>
...
export default compose(withConnect)(ChatThaiRanSanXuat);
