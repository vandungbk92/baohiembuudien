...
class ChatThaiNguyHaiCoSoXuLy extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} name="form_chatthainguyhai" layout='vertical' size='small' autoComplete='off'
      ...
      <Divider orientation="left">3. Chất thải nguy hại</Divider>
      <Row gutter={10}>
        <Col {...layoutCol2}>
          <Form.Item label={<b>a. Tổng khối lượng thu gom:</b>} name="klthugom" validateTrigger={['onChange', 'onBlur']}
          >
            <Input placeholder='Khối lượng thu gom' disabled={loading}/>
          </Form.Item>
        </Col>
...
export default compose(withConnect)(ChatThaiNguyHaiCoSoXuLy);
