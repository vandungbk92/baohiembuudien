...
class ChatThaiYTeKhongNguyHai extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} name="form_chatthaiyte" layout='vertical' size='small' autoComplete='off'
                 onValuesChange={this.onFieldsChange}>
      <Form.Item label="" name="_id" hidden={true}>
        <Input/>
      </Form.Item>
      <Divider orientation="left">2. Chất thải y tế không nguy hại</Divider>
      <Row gutter={10}>
        <Col {...layoutCol}>
...
export default compose(withConnect)(ChatThaiYTeKhongNguyHai);
