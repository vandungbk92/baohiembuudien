...
const layoutCol2 = { 'xs': 12, 'sm': 12, 'md': 12, 'lg': 8, 'xl': 4, 'xxl': 4 };
const layoutCol3 = { 'xs': 24, 'sm': 24, 'md': 24, 'lg': 12, 'xl': 12, 'xxl': 12 };

class ChatThaiChanNuoi extends Component {
  ...
  render() {
    ...
    return <Form ref={this.formRef} layout='vertical' size='small' autoComplete='off' onFinish={this.onFinish}
                 onValuesChange={this.onFieldsChange} name="form_chatthaichannuoi">
      <Form.Item label="" name="_id" hidden={true}>
        <Input/>
      </Form.Item>
      <Divider orientation="left">2. Chất thải rắn chăn nuôi</Divider>
      <Row gutter={10}>
        <Col {...layoutCol}>
          <Form.Item label={<b>a. Tổng khối lượng phát sinh</b>} name="klphatsinh"
      ...
      <Col sm={24}><strong>c. Công nghệ xử lý chất thải (Lựa chọn 1 hoặc nhiều phương án) (tấn/năm)</strong></Col>
      <Row gutter={10}>
        <Col {...layoutCol2}>
      ...
      <Col sm={24}><strong>d. Đơn vị tiếp nhận, xử lý chất thải rắn chăn nuôi</strong></Col>
...
export default compose(withConnect)(ChatThaiChanNuoi);
