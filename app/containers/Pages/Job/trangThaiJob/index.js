...
import { add, getById, getAll, delById, updateById } from '@services/job/trangThaiJobService';
...
import DonViTinhModal from '@containers/Pages/Job/trangThaiJob/TrangThaiModal';
import { makeGetMyInfo } from '../../../Layout/HeaderComponent/HeaderProvider/selectors';
import { CONSTANTS } from '@constants';



class TrangThaiJob extends Component {
...
export default withConnect(TrangThaiJob);
